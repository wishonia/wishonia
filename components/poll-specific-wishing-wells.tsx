...
export const PollSpecificWishingWells: React.FC<PollProps> = ({ thisWishingWell,
                                                                    thatWishingWell,
                                                                    updatePair, user }) => {

    const getWishingWellName = (item: {
        name: string;
    }) => item.name;

    const getWishingWellImage = (item: {
    ...
    const createWishingWellAllocation = (
        ...
        localStorage.setItem("wishingWellPairAllocation", JSON.stringify(allocation));
    };
