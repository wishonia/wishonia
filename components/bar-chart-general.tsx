            ...
            <div style={{
                ...
                <div style={{display: 'flex', width: '100%', justifyContent: 'space-between', height: '100%'}}>
                    <div style={{
                        ...
                        <span id="thisPercentageDesiredLabel" className="text-sm text-center">
                        ...
                        <div
                            ...
                            style={{
                                ...
                                width: '100%',
                                backgroundImage: getItemImage(thisItem) ? `url(${getItemImage(thisItem)})` : 'linear-gradient(to bottom, #007bff, #007bff)',
                    ...
                    <div style={{
                        ...
                        <span id="thatPercentageDesiredLabel" className="text-sm text-center">
                        ...
                        <div
                            ...
                            style={{
                                ...
                                width: '100%',
                                backgroundImage: getItemImage(thatItem) ? `url(${getItemImage(thatItem)})` : 'linear-gradient(to bottom, #007bff, #007bff)',
