...
const features: FeatureCardProps[] = [
    {
        Icon: Bot,
        title: "DIGITAL TWINS",
        description: "AI agents aligned to your goals, automating tasks and coordinating with 8 billion other digital twins. ",
        listItems: [
        ...
        //path: "/dashboard",
        imageUrl: "/assets/Digital Twin Knowledge Agent brains consuming existing data.jpg"
    },
    {
        Icon: Network,
        title: "POSITRON AGENTS",
        description: "Prosocial AI agents representing nonprofits, DAOs, and other institutions working to automate the production of public goods.",
        // listItems: [
    ...
    },
    {
        Icon: Vote,
        title: "WISHOCRACY",
        description: "Uses Aggregated Pairwise Preference Allocation (APPA) to " +
    ...
    return (
        <div className="min-h-screen bg-white text-black font-mono">
            <header className="border-b-8 border-black p-8 text-center">
                <h1 className="text-6xl font-bold mb-4">FORKABLE WORLD</h1>
                <p className="text-2xl">
                    A system for coordinating human and artificial collective intelligence to maximize universal health and happiness!
                </p>
            </header>
            <main className="flex flex-col md:flex-row md:flex-wrap p-8">
