...
const fieldDescriptions: Record<keyof DrugClassificationProfile, string> = {
  ...
  classification:
    "Final classification of the drug based on the calculated scores",
}
...
const Gauge: React.FC<{
  ...
  return (
    <div className="relative h-8 w-full overflow-hidden rounded-full bg-gray-300">
      <motion.div
        initial={{ width: 0 }}
...
const DrugClassificationFormGoogle: React.FC = () => {
  ...
  function calculateScores(
    profile: DrugClassificationProfile
  ): DrugClassificationProfile {
  ...
  const renderInput = (key: keyof DrugClassificationProfile) => {
    ...
    switch (key) {
      ...
      case "societalCostIndex":
        return (
          <input
            ...
            max="100"
            step="1"
            className="h-2 w-full cursor-pointer appearance-none rounded-lg bg-gray-200" // Style the range input
          />
        )
      ...
      default:
        return <input type="number" {...commonInputProps} step="0.01" />
    }
  }

  return (
    <div className="mx-auto w-full max-w-4xl rounded-lg bg-gray-100 p-8 font-sans shadow-md">
      {/* Title */}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded-md border bg-gray-50 p-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <button
            type="submit"
            className="w-full rounded-md bg-blue-500 p-3 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300"
          >
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          ...
          >
            <h4 className="text-lg font-bold text-gray-800">DEA Scheduling</h4>
            <p className="font-semibold text-gray-700">
