...
interface GlobalSolutionContributionsAddFormProps {
...
export function GlobalSolutionContributionsAddForm({ globalSolutionId, setShowLogAlert }: GlobalSolutionContributionsAddFormProps) {
  ...
  async function onSubmit(data: z.infer<typeof FormSchema>) {
    ...
    if (!response?.ok) {
      ...
      toast({
        description: "Your globalSolution has been logged successfully.",
      })
    }
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              ...
              <FormDescription>
                Date when the globalSolution is performed.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
