...
export default function AgentListMine() {
            ...
            >
              ...
              >
                ...
                <div className="mt-2 hidden flex-wrap justify-start md:ml-auto  md:mr-2 md:flex">
                  ...
                  >
                    {agent.sharingLevel === SharingLevel.PRIVATE && "Only me"}
                    {agent.sharingLevel === SharingLevel.UNPUBLISHED_LINK && "Unpublished link"}
                    {agent.sharingLevel === SharingLevel.PUBLISHED && "Published"}
                  </Badge>
                </div>
              </Link>
