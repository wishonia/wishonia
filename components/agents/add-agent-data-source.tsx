...
export default function AddAgentDataSource() {
  return (
    <>
      <div className="mx-auto w-full max-w-md rounded-lg bg-[#1A1A1A] p-8 text-white">
        <h1 className="mb-6 text-3xl font-bold">Create a new bot</h1>
        <div className="mb-6">
          <h2 className="mb-4 text-lg font-semibold">Select a data source</h2>
        ...
        <Button className="w-full rounded-md bg-[#4F46E5] py-3 text-lg font-semibold">
          Create
        </Button>
      </div>
    </>
