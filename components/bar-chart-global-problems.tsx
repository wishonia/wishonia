...
const BarChartGlobalProblems: React.FC<BarChartProps> = ({ thisGlobalProblem,
                                               thatGlobalProblem,
                                               thisPercentageDesired}) => {

     const getGlobalProblemName = (globalProblem: GlobalProblem) => "Solving "+ globalProblem.name;
    const getGlobalProblemImage = (globalProblem: GlobalProblem) => globalProblem.featuredImage || "";
