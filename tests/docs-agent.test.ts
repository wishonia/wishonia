...
describe("Docs Generator", () => {
  ...
  it("Parses the functional components overview documentation file and creates individual page", async () => {
    ...
    for (const section of sections) {
      ...
      let contentInstructions = `Please create a detailed product requirements document in markdown for the following
      ...
      await generateMarkdownAndImageFromDescription(
        outputPath,
        title,
        section,
        contentInstructions
