...
const translations = {
    "en": {
        ...
        "WarPercentageDesiredPollHeader": "Desired Allocation Poll",
        "WarPercentageDesiredDescription": "How do you think funds should be allocated between war (Option A) and clinical research (Option B)? Adjust the slider to reflect your desired allocation.",
        "warPercentageGuessedPollHeader": "Actual Allocation Poll",
        "warPercentageGuessedDescription": "How do you think funds are actually allocated between war (Option A) and clinical research (Option B)? Adjust the slider to reflect your perceived actual allocation.",
