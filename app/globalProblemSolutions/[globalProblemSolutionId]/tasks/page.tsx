...
export async function generateMetadata({params}: GlobalProblemSolutionTasksPageProps): Promise<Metadata> {
    return {
        title: heading,
...
export default async function GlobalTasks({params}: GlobalProblemSolutionTasksPageProps) {
