...
export default function ProfileForm({ user }: { user: User & { userSkills: UserSkillWithSkill[] } }) {
    ...
    const renderSection = (title: string, section: FormSection, content: React.ReactNode) => (
    ...
    return (
        <form className="space-y-8">
                ...
                <>
                    <div className="space-y-2">
                        <Label htmlFor="username" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                            ...
                            <UserIcon size={16} className="absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-400" />
                        </div>
            ...
            {renderSection("Contact Information", "contact", (
                <>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="phoneNumber" {...register('phoneNumber')} placeholder="+1 (123) 456-7890" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            {errors.stateProvince && <p className="text-red-500">{errors.stateProvince.message}</p>}
                        </div>
                        <div>
            ...
            {renderSection("Online Presence", "online", (
                <div className="space-y-6">
                    <div className="grid grid-cols-1 gap-6">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Input id="website" {...register('website')} className="pl-20" placeholder="www.example.com" />
                                <span className="absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-500 text-sm">https://</span>
                            </div>
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        <div className="space-y-2">
                            <Label htmlFor="blog" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                                <Globe size={16} className="text-gray-500" />
                                Blog
                            </Label>
                            <div className="relative">
                                <Input id="blog" {...register('blog')} className="pl-20" placeholder="blog.example.com" />
                                <span className="absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-500 text-sm">https://</span>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <Label htmlFor="githubUsername" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                                <Github size={16} className="text-gray-500" />
                                GitHub Username
                            </Label>
                            <div className="relative">
                                <Input id="githubUsername" {...register('githubUsername')} className="pl-8" placeholder="github-user" />
                                <Github size={16} className="absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-400" />
                            </div>
                            {errors.githubUsername && <p className="text-sm text-red-500">{errors.githubUsername.message}</p>}
                        </div>
                        <div className="space-y-2">
                            <Label htmlFor="twitterHandle" className="flex items-center gap-2 text-sm font-medium text-gray-700">
                                <Twitter size={16} className="text-gray-500" />
                                Twitter Handle
                            </Label>
                            <div className="relative">
                                <Input id="twitterHandle" {...register('twitterHandle')} className="pl-8" placeholder="twitter_handle" />
                                <span className="absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-500 text-sm">@</span>
                            </div>
                            {errors.twitterHandle && <p className="text-sm text-red-500">{errors.twitterHandle.message}</p>}
                        </div>
                    </div>
                </div>
            ))}

            {renderSection("Preferences and Settings", "preferences", (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-center space-x-2">
                        <Checkbox id="newsletterSubscribed" {...register('newsletterSubscribed')} />
                        <Label htmlFor="newsletterSubscribed" className="flex items-center gap-2">
                            <Mail size={18} />
                    ...
                    <div className="flex items-center space-x-2">
                        <Checkbox id="contributorsEnabled" {...register('contributorsEnabled')} />
