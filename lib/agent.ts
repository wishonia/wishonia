...
export async function getOrCreateAgent(agentData: {
    ...
    return prisma.agent.upsert({
        ...
        create: {
            ...
            initialMessage: agentData.initialMessage || "Hello, how can I help you today?",
            ...
            conversationStarters: agentData.conversationStarters || ["What can you do?"],
        },
    });
}

export async function createAgentDatasource(agentId: string, datasourceId: string) {
